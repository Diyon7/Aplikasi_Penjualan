...
Public Class laporandatamember
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Final_Project.laporandatamember.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporandatamember
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporandatamember = New laporandatamember()
        rpt.Site = Me.Site
        Return rpt
    End Function
